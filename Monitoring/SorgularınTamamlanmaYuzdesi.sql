...
WHERE r.command IN ('BACKUP DATABASE','BACKUP LOG','RESTORE DATABASE','RESTORE VERIFYON','RESTORE HEADERON', 'RESTORE HEADERONLY','DbccSpaceReclaim', 'DbccFilesCompact', 'DBCC')